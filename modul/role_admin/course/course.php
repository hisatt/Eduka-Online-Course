...
<div id="course">
    <a href="?page=course&action=tambah" class="btn btn-info">
        <span class="text">Tambah Course</span>
    </a>
    <div class="form-tambah mt-2 mb-2" <?php if ($clasTambahShow === false) { ?>style="display:none" <?php } ?>>
